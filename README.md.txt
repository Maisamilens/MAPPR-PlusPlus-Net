Here is the complete, detailed `README.md` for your GitHub repository. It includes comprehensive architectural references with active URLs, dataset instructions tailored to your specific paths, and proper acknowledgments to the researchers and repositories you mentioned.
